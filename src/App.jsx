...
function App() {
  useEffect(() => {
    ...
    window.fbq("init", "2259159114243836");
  ...
  return (
    <>
      ...
      <Helmet>
        <noscript>{`<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2259159114243836&ev=PageView&noscript=1"/>`}</noscript>
      </Helmet>
