...
const LandingPage = () => {
  return (
    <section className="bg-gradient-to-b from-[#0a1333] to-black text-white py-12 px-6 md:px-16 lg:px-32">
      <div className="text-center max-w-4xl mx-auto">
        <div className="inline-block px-5 py-1 border border-gray-600 rounded-full text-sm mb-5">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
        <div className="flex flex-col items-center">
          <div className="relative w-56 h-56 rounded-full overflow-hidden border-8 border-yellow-400">
            <img
              src="/images/Nilji.png"
              alt=""
              className="w-full h-full object-cover rotate-270"
            />
          </div>
          ...
          <div className="bg-[#11192e] mt-6 p-6 rounded-xl text-center max-w-md">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Trained over{" "}
              <span className="font-bold">3000 Public Speakers</span> & helped
              <span className="font-bold"> 170+ people</span> to achieve their
              goals
            </p>
          </div>
        </div>
